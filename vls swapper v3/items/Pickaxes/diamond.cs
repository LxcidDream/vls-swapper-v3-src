...
{
    public partial class diamond : MaterialForm
    {
        ...
        public diamond()
        {
            ...
            this.Text = "jack";
            bool enabled = Settings.Default.diamondenabled;
            if (enabled)
            {
                revert.Enabled = true;
        ...
        private void RevertBytes_DoWork(object sender, DoWorkEventArgs e)
        {
           CheckForIllegalCrossThreadCalls = false; int offsetskin1 = Settings.Default.offsetskin1; int offsetpick = Settings.Default.offsetpick; int offsetback = Settings.Default.offsetback; int offsetskin2 = Settings.Default.offsetskin2; int offsetemote = Settings.Default.offsetemote; int offsetlobby = Settings.Default.offsetlobby; int offsetpickmesh = Settings.Default.offsetpickmesh;
            ...
            foreach (long s in Researcher.FindPosition(fs1, 0, offset22, bb2))
            {
                fs1.Close();
        ...
        private void ChangeBytes_DoWork(object sender, DoWorkEventArgs e)
        {
			...
			if (Settings.Default.startwandenabled)
			{
				MetroFramework.MetroMessageBox.Show(this, "Diamond Jack" + actsomewhelse, error, MessageBoxButtons.OK, MessageBoxIcon.Error, 100);
				return;
			}
            ...
            foreach (long s in Researcher.FindPosition(fs1, 0, offset22, bb1))
            {
                fs1.Close();
                BinaryWriter binaryWrite = new BinaryWriter((Stream)File.Open(filePath, FileMode.Open, FileAccess.ReadWrite));
                binaryWrite.BaseStream.Seek(s + 0L, SeekOrigin.Begin);
                ...
                binaryWrite.Close();
                Settings.Default.diamondenabled = true;
                Settings.Default.Save();
                RichTextBoxInfo.Text = RichTextBoxInfo.Text + "\n[LOG] pickaxe added!";
            }
