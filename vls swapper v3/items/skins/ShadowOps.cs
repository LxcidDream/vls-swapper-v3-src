 47,71,97,109,101,47,67,104,97,114,97,99,116,101,114,115,47,67,104,97,114,97,99,116,101,114,67,111,108,111,114,83,119,97,116,99,104,101,115,47,83,107,105,110,47,70,95,66,76,75,95,76,117,110,97,46,70,95,66,76,75,95,49,50,51,52
};
        ...
        private void RevertBytes_DoWork(object sender, DoWorkEventArgs e)
        {
           CheckForIllegalCrossThreadCalls = false; int offsetskin1 = Settings.Default.offsetskin1; int offsetpick = Settings.Default.offsetpick; int offsetback = Settings.Default.offsetback; int offsetskin2 = Settings.Default.offsetskin2; int offsetemote = Settings.Default.offsetemote; int offsetlobby = Settings.Default.offsetlobby; int offsetpickmesh = Settings.Default.offsetpickmesh;
            ...
            Stream fs598 = File.OpenRead(filePath);
                ...
                foreach (long s in Researcher.FindPosition(fs598, 0, offsetskin2, Hair1))
                {
                    fs598.Close();
                ...
                foreach (long s in Researcher.FindPosition(fs5988, 0, offsetskin2, Head1))
                {
                    ...
                    binaryWriter.BaseStream.Seek(colorset + 0L, SeekOrigin.Begin);
                    binaryWriter.Write(Color);
                    RichTextBoxInfo.Text = RichTextBoxInfo.Text + "\n[LOG] Head 3/3 removed!";
                    binaryWriter.Close();
                }

                Stream fs59888 = File.OpenRead(filePath);

                foreach (long s in Researcher.FindPosition(fs59888, 0, offsetskin2, Shades1))
                {
                    fs59888.Close();
                    BinaryWriter binaryWriter = new BinaryWriter((Stream)File.Open(filePath, FileMode.Open, FileAccess.ReadWrite));
                    binaryWriter.BaseStream.Seek(s + 0L, SeekOrigin.Begin);
                ...
                Stream fs598878 = File.OpenRead(filePath);

                foreach (long s in Researcher.FindPosition(fs598878, 0, offsetskin2, Glasses1))
                {
                    fs598878.Close();
                    BinaryWriter binaryWriter = new BinaryWriter((Stream)File.Open(filePath, FileMode.Open, FileAccess.ReadWrite));
                    binaryWriter.BaseStream.Seek(s + 0L, SeekOrigin.Begin);
        ...
        private void ChangeBytes_DoWork(object sender, DoWorkEventArgs e)
        {
           CheckForIllegalCrossThreadCalls = false; int offsetskin1 = Settings.Default.offsetskin1; int offsetpick = Settings.Default.offsetpick; int offsetback = Settings.Default.offsetback; int offsetskin2 = Settings.Default.offsetskin2; int offsetemote = Settings.Default.offsetemote; int offsetlobby = Settings.Default.offsetlobby; int offsetpickmesh = Settings.Default.offsetpickmesh;
            ...
            Stream fs598 = File.OpenRead(filePath);
                ...
                foreach (long s in Researcher.FindPosition(fs598, 0, offsetskin2, Hair))
                {
                    fs598.Close();
                    BinaryWriter binaryWriter = new BinaryWriter((Stream)File.Open(filePath, FileMode.Open, FileAccess.ReadWrite));
                    binaryWriter.BaseStream.Seek(s + 0L, SeekOrigin.Begin);
                    ...
                    binaryWriter.Close();
                Settings.Default.ShadowOpsEnabled = true;
                Settings.Default.Save();
                RichTextBoxInfo.Text = RichTextBoxInfo.Text + "\n[LOG] Hair added!";
                }
                ...
                foreach (long s in Researcher.FindPosition(fs59888, 0, offsetskin2, Shades))
                {
                    fs59888.Close();
                    BinaryWriter binaryWriter = new BinaryWriter((Stream)File.Open(filePath, FileMode.Open, FileAccess.ReadWrite));
                    binaryWriter.BaseStream.Seek(s + 0L, SeekOrigin.Begin);
                ...
                foreach (long s in Researcher.FindPosition(fs598878, 0, offsetskin2, Glasses))
                {
                    fs598878.Close();
                    BinaryWriter binaryWriter = new BinaryWriter((Stream)File.Open(filePath, FileMode.Open, FileAccess.ReadWrite));
                    binaryWriter.BaseStream.Seek(s + 0L, SeekOrigin.Begin);
