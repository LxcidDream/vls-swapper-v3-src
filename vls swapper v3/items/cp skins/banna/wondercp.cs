...
{
    public partial class wondercp : MaterialForm
    {
        ...
        public wondercp()
        {
            ...
            this.Text = "Wonder";
            bool enabled = Settings.Default.cpwonderenabled;
            if (enabled)
            {
                revert.Enabled = true;
		...
		private void convert_Click(object sender, EventArgs e)
        {
			...
			wondercp.ReplaceBytes(filePath, 3268051L, wondercp.head);
			wondercp.ReplaceBytes(filePath, 3268051L, wondercp.head1);
			this.RichTextBoxInfo.AppendText("\n[LOG] head added!");
			wondercp.ReplaceBytes(filePath, 3264546L, wondercp.body);
			wondercp.ReplaceBytes(filePath, 3264546L, wondercp.body1);
			this.RichTextBoxInfo.AppendText("\n[LOG] body added!");
			wondercp.ReplaceBytes(filePath, 214396139L, wondercp.cp);
			wondercp.ReplaceBytes(filePath, 214396139L, wondercp.cp1);
			this.RichTextBoxInfo.AppendText("\n[LOG] cp added!");
			Settings.Default.cpskinEnabled = true;
			Settings.Default.cpwonderenabled = true;
